...
public class NearbyModule extends ReactContextBaseJavaModule {
    ...
    NearbyModule(ReactApplicationContext context) {
        ...
        //this.connectionsActivity = new ConnectionsActivity();
    }
    @Override
    ...
    public void getDiscoveredEndpoints(Callback callback) {
        ...
        callback.invoke(endpointsArray);
    }
    ...
    private final EndpointDiscoveryCallback endpointDiscoveryCallback =
            new EndpointDiscoveryCallback() {
                ...
                public void onEndpointFound(String endpointId, DiscoveredEndpointInfo info) {
                    ...
                    // Updating the currentTimeFound variable.
                    currentTimeFound = LocalTime.now();
                    String toastMessage = "Endpoint found: " + endpointId+ LocalTime.now().toString();
                    ...
                    new ConnectionLifecycleCallback() {
                        ...
                        public void onConnectionInitiated(String endpointId, ConnectionInfo connectionInfo) {
                            ...
                            if (discoveryCallback != null) {
                                discoveryCallback.invoke(currentTimeFound.toString(), LocalTime.now().toString());
                            }
                        }
